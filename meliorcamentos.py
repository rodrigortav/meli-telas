...
LINKS_PRODUTO = {
    ...
    70.00: "https://www.mercadolivre.com.br/tela-mosquiteira-em-fibra-de-vidro-pedidos-personalizados/up/MLBU3830846992",
...
def saudacao():
    ...
    if 5 <= hora < 12: return "Olá!"
    elif 12 <= hora < 18: return "Olá!"
    else: return "Olá!"
    ...
    if not pergunta:
        ...
        if not itens:
            ...
            texto_final = (
                ...
                f"{''.join(blocos_links)}\n\n"
                f"(Após a compra, me chame pelo chat da compra e me informe as medidas para registrar a produção do seu pedido) Qualquer dúvida estou à disposição! Obrigada"
            )
